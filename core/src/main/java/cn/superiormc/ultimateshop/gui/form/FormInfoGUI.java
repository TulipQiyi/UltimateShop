...
public class FormInfoGUI extends FormGUI {
    ...
    public void constructGUI() {
        ...
        // 购买
        ButtonComponent buy = ButtonComponent.of(TextUtil.parse(player, ConfigManager.configManager.getStringWithLang(player,
                "menu.bedrock.info.buttons.buy", "Buy", "item-name", itemName)));
        // 回收
        ButtonComponent sell = ButtonComponent.of(TextUtil.parse(player, ConfigManager.configManager.getStringWithLang(player,
                "menu.bedrock.info.buttons.sell", "Sell", "item-name", itemName)));
        // 一键回收
        ButtonComponent sellAll = ButtonComponent.of(TextUtil.parse(player, ConfigManager.configManager.getStringWithLang(player,
                "menu.bedrock.info.buttons.sell-all", "Sell All", "item-name", itemName)));
        // 选择数量
        ButtonComponent buyMore = ButtonComponent.of(TextUtil.parse(player, ConfigManager.configManager.getStringWithLang(player,
        ...
        // 返回
        ButtonComponent back = ButtonComponent.of(TextUtil.parse(player, ConfigManager.configManager.getStringWithLang(player,
